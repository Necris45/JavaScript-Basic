...
const game = {
    ...
    reset() {
        ...
        this.wall.setCoordinates(this.getWallRandomFreeCoordinates())
        this.render();
    },
    ...
    getRandomFreeCoordinates() {
        const exclude = [this.wall.getCoordinates(), this.food.getCoordinates(), ...this.snake.getBody()];
    ...
    canMakeStep() {
        ...
        return !this.snake.isOnPoint(nextHeadPoint) && !this.wall.isOnPoint(nextHeadPoint);
    }
};
